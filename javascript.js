...
function avancar1(){
    if(concluida == 1){
        ...
        elemento.innerHTML += '<input class="me" type="button" value="d) Porque são países que cresceram rapidamente" onclick="q()" id="cert">'
...
function avancar2(){
    if(concluida == 1){
        ...
        elemento.innerHTML += '<input class="me" type="button" value="b) Auxilio econômico para os países destruídos" onclick="q()" id="cert">'
...
function avancar3(){
    if(concluida == 1){
        ...
        elemento.innerHTML += '<input class="me" type="button" value="a) Indonésia, Vietnã, Malásia, Tailândia e Filipinas" onclick="q()" id="cert">'
